...
class Student:
    def __init__(self, student_id: str , course: list[str])->None:
...
scuola.enroll_student("1002", "Matematica")
scuola.enroll_student("1002", "Fisica")

# Ricerca degli studenti iscritti a un corso specifico
print(scuola.search_by_course("Matematica"))
print(scuola.search_by_course("Fisica"))
print(scuola.search_by_course("Chimica"))